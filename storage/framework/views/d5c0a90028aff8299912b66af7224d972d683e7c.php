                        ...
                        <div class="col-sm-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form action="/tangki_b/edit/proses/<?php echo e($e -> id); ?>" method="post" novalidate="novalidate" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12" align="right">
                                                ...
                                                <a href="/tangki_b" class="btn btn-secondary">Kembali</a>
                                            </div>
                                        </div>
                                    </form>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ujicobalaravel1\resources\views/tangki2/edit.blade.php ENDPATH**/ ?>