                        ...
                        <div class="col-sm-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <?php endif; ?>
                                    <form action="/tangki_b/tambah/proses" method="post" novalidate="novalidate" enctype="multipart/form-data">
...
<?php echo $__env->make('index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ujicobalaravel1\resources\views/tangki2/tambah.blade.php ENDPATH**/ ?>