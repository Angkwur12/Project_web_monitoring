                        ...
                        <div class="col-sm-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form action="/tangki_d/edit/proses/<?php echo e($e -> id); ?>" method="post" novalidate="novalidate" enctype="multipart/form-data">
...
<?php echo $__env->make('index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ujicobalaravel1\resources\views/tangki4/edit.blade.php ENDPATH**/ ?>