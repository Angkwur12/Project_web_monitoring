            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <a href="/tangki_a/tambah" class="btn btn-primary">Tambah</a>
                    </div>
                            ...
                            <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                    ...
                                    <tr class="odd gradeX">
                                        ...
                                        <td class="center">                                            
                                            <a href="/tangki_a/edit/<?php echo e($e -> id); ?>" class="btn btn-warning btn-sm">Edit</a>
                                            |
                                            <a href="/tangki_a/hapus/<?php echo e($e -> id); ?>" class="btn btn-danger btn-sm">Hapus</a>
                                        </td>
                                    </tr>
...
<?php echo $__env->make('index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ujicobalaravel1\resources\views/tangki1/tampil.blade.php ENDPATH**/ ?>