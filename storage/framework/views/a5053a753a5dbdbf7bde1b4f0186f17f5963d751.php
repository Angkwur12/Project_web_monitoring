            ...
            <div class="row">
                <div class="col-md-12">
                    <h1 class="page-header">
                        Diagram <small>Data Tangki A</small>
                    </h1>
                </div>
            </div>
                ...
                <div class="col-md-6 col-sm-12 col-xs-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <h4><b>Kapasistas Maksimum : 350 M3</b></h4>
                        </div>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ujicobalaravel1\resources\views/chart_tangki/tangki.blade.php ENDPATH**/ ?>